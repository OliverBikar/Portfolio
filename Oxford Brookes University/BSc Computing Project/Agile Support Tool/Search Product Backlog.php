					...
					<tr class='.$colour.'>
						...
						<div class="col">
							<td>
								...
								<a class="delete" href="Delete User Story.php?user_st_id='.$row["userStoryID"].'">
