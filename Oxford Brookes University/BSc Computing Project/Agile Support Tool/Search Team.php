			...
			$output .= '
				<div class="row">
					<tr>
						...
						<div class="col">
							<td>
								<a href="View Team.php?team_id='.$row["teamID"].'"><button class="btn btn-dark btn-sm" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="View Team Members"><i class="fa fa-users"></i></button></a>
								<a href="Edit Team.php?team_id='.$row["teamID"].'"><button class="btn btn-dark btn-sm" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Edit Team"><i class="fa fa-edit"></i></button></a>
							</td>
						</div>
					</tr>';
		}
