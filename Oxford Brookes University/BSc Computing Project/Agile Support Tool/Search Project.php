			...
			$output .= '
				<div class="row">
					<tr>
						...
						<div class="col">
							<td>
								<a href="Edit Project.php?project_id='.$row['projectID'].'"><button class="btn btn-dark btn-sm" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Edit Project"><i class="fa fa-edit"></i></button></a>
								<a class="delete" href="Delete Project.php?project_id='.$row['projectID'].'"><button class="btn btn-dark btn-sm" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Delete Project"><i class="fa fa-trash"></i></button></a>
							</td>
					</tr>';
		}
		echo '</table>';
