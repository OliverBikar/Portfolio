							...
							<?php
								...
								if(isset($_POST['submit'])){
									...
									if(mysqli_query($conn,$query)) {
										header("location: Staff Sprint Backlog Page.php?user_st_id=".$id."");
									}
								}
							?>
									...
									echo "
										  <div class='row'>
											  <tr class=".$colour.">
												...
												<div class='col'>
													<td>
														<a href='Staff Edit Task.php?task_id=".$row['taskID']."&userStory=".$id."''>
														...
														<a class='delete' href='Staff Delete Task.php?task_id=".$row['taskID']."'>
