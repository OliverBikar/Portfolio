							...
							<?php
								...
								if(isset($_POST['submit'])) {
									...
									if(mysqli_query($conn,$query)) {
										echo "<script>window.alert('Your Project has been created. Please assign it to a team to access your project.'); window.location.href='Staff Team Page.php';</script>";
									}
								}
							?>
							<div id="projectForm">
